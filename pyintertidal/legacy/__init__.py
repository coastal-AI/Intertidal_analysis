...
:mod:`~pyintertidal.legacy.bathymetry`
    ...
    server-side ``step``.
    **Replaced by** :func:`pyintertidal.elevation.fit_hsr` and
    :func:`pyintertidal.elevation.fit_step`, both local and cloud-free. The
    RMSE figures that used to justify that replacement were measured against
    the IGN LiDAR and are withdrawn — see
    :mod:`pyintertidal.legacy.bathymetry`.
